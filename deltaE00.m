...
% function   De00=deltaE00(Lab1, Lab2, kL,kC,kH)
%  1.1 2001/01/08 15:18:05 latpci - intial release
%  1.2 2010/02/03 07:20:00 latpci - added parametric factors
...
%De00 = ((DLP./kL./SL).^2+(DCP./kC./SC).^2+(DHP./kH./SH).^2).^(1/2);
